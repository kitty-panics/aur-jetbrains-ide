...
+ 跟随官网不断更新
    ...
    - jetbrains-goland        `v2024.1.5`
    - jetbrains-intellij-idea `v2024.1.5`
    - jetbrains-phpstorm      `v2024.1.5`
    - jetbrains-pycharm       `v2024.1.5`
    - jetbrains-rider         `v2024.1.5`
    - jetbrains-rubymine      `v2024.1.5`
    - jetbrains-webstorm      `v2024.1.5`
+ 永远停留在 `2021.2.X`
