...
+ 跟随官网不断更新
    - jetbrains-clion         `v2023.3.1`
    - jetbrains-datagrip      `v2023.3.1`
    - jetbrains-dataspell     `v2023.3.1`
    - jetbrains-goland        `v2023.3.1`
    - jetbrains-intellij-idea `v2023.3.1`
    - jetbrains-phpstorm      `v2023.3.1`
    - jetbrains-pycharm       `v2023.3.1`
    - jetbrains-rider         `v2023.3.1`
    - jetbrains-rubymine      `v2023.3.1`
    - jetbrains-webstorm      `v2023.3.1`
+ 永远停留在 `2021.2.X`
