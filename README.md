...
+ 跟随官网不断更新
    - jetbrains-clion         `v2023.1.3`
    - jetbrains-datagrip      `v2023.1.2`
    - jetbrains-dataspell     `v2023.1.3`
    - jetbrains-goland        `v2023.1.3`
    - jetbrains-intellij-idea `v2023.1.3`
    - jetbrains-phpstorm      `v2023.1.3`
    - jetbrains-pycharm       `v2023.1.3`
    - jetbrains-rider         `v2023.1.3`
    - jetbrains-rubymine      `v2023.1.3`
    - jetbrains-webstorm      `v2023.1.3`
+ 永远停留在 `2021.2.X`
